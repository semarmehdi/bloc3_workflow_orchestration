...
from tasks_with_api.extract_fraud import extract_transactions_batch_to_s3
from tasks_with_api.transform_predict_fraud import predict_with_model_fraud
from tasks_with_api.notify_fraud import send_fraud_notification
...
with DAG(
    dag_id="etl_fraud_batch_api_dag",
    default_args=default_args,
    start_date=datetime(2025, 1, 1),
    schedule=None,
    catchup=False,
    tags=["demo", "etl", "batch", "api", "fraud"],
) as dag:
    ...
    # branche unique : extract puis transform
    ...
    # =========================
    # 4) NOTIFY (email) en parallele du load, juste apres predict
